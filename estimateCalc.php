		...
		<nav>
			<ul>
				<div class="navBorder">
					...
					<li class="active"><a href="../estimateCalc.php" class="niceNav">Estimator</a></li>
					<li><a href="../contactUs.php" class="niceNav">Contact Us</a></li>
				</div>
			</ul>
...
<!------------------------Banner------------------------>
		<div class="banner">
			<a href="../index.html"><img src="../img/driveway1final.png" alt="make a banner" title="LT Terrassement Banner"/></a>
		</div>
<!------------------------Slogan------------------------>
		<div class="slogan">
